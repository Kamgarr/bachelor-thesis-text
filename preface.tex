...
This thesis is organised as follows: \Cref{chapt:over} talks about techniques used in computer games and simulations and proposed approaches with the goal of improving already used techniques. \Cref{chapt:technology} introduces libraries that can be beneficial in creating a destructible environment. The last chapter\todo{ref} describes the design of our implementation and presents measurements of its performance. After conclusion we continue with two appendices, first/todo{ref} of them is a user guide to our application and the second /todo{ref} provides some insight into the inner structure of the application. 
