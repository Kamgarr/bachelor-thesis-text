...
The application provides only one console parameter. It is {\tt -d} and it enables debug information to be rendered. In other words, it draws the collision shapes and bounding boxes around the objects.
