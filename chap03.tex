...
To record the time data, we implemented a simple Timer that can be inserted into the code and can return the real time passed since its creation. We recorded 580 collisions in a game world with following objects and their number of triangles: 7x\emph{media/building.obj}, 60 triangles; 1x\emph{media/missile.obj}, 142 triangles; 1x\emph{media/ship.obj}, 104 triangles. We repeatedly shot the buildings at random locations. Recorded data can be seen in \cref{tab:performace} and \cref{fig:boxtimes}.
